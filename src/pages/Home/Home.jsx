...
const Home = () => {
  ...
  return (
    <div className="grid grid-cols-4  gap-x-5 mx-5 py-1">
      <div className="grid grid-cols-2 gap-4 col-span-3 gap-y-10">
          ...
          <div className="bg-white pb-4">
            <div className="bg-rose-500 p-4 grid grid-cols-2">
              <div className="flex flex-col items-center justify-end text-white">
                ...
                <h1 className="text-3xl">Saadilive</h1>
            ...
            <div className="p-4 text-center">
              ...
              <button className="bg-rose-500 w-3/5 max-w-full py-2 mt-4 shadow-lg shadow-rose-200 rounded-full text-white font-bold">
                Tell me more
              </button>
            </div>
          </div>
